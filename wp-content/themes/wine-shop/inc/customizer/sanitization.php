 ...
 */
function wineshop_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function wineshop_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function wineshop_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function wineshop_sanitize_float( $input ) {
 ...
 */
function wineshop_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function wineshop_sanitize_html( $html ) {
 ...
 */
function wineshop_sanitize_image( $image, $setting ) {
 ...
 */
function wineshop_sanitize_nohtml( $nohtml ) {
 ...
 */
function wineshop_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function wineshop_sanitize_range_value( $number, $setting ) {
 ...
 */
function wineshop_sanitize_select( $input, $setting ) {
 ...
 */
function wineshop_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function wineshop_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function wineshop_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
