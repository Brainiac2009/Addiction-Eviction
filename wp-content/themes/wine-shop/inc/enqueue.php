...
add_action( 'customize_controls_enqueue_scripts', function() {
	...
	wp_enqueue_script(
		'wineshop-customize-section-button',
...
function wineshop_scripts() {
	...
	wp_enqueue_style('wineshop-editor-style',get_template_directory_uri().'/assets/css/editor-style.css');

	wp_enqueue_style('wineshop-main', get_template_directory_uri() . '/assets/css/main.css');

	wp_enqueue_style('wineshop-woo', get_template_directory_uri() . '/assets/css/woo.css');
	
	wp_enqueue_style( 'wineshop-style', get_stylesheet_uri() );
	...
	wp_enqueue_script('wineshop-custom-js', get_template_directory_uri() . '/assets/js/theme.js', array('jquery'), false, true);

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'wineshop_scripts' );
